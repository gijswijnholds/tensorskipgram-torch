...
from tensorskipgram.preprocessing.main_preprocessing import main as preprocessing_main
from tensorskipgram.evaluation.main_evaluation import main as evaluation_main
from tensorskipgram.training.main_training import main as training_main
